...
use QrCode\Exceptions\DataDoesntExistsException;
use QrCode\Exceptions\FreeTypeLibraryMissingException;
use QrCode\Exceptions\ImageFunctionFailedException;
use QrCode\Exceptions\VersionTooLargeException;
use QrCode\Exceptions\ImageSizeTooLargeException;
use QrCode\Exceptions\ImageFunctionUnknownException;
...
class QrCode
{
    ...
    public function setErrorCorrection($error_correction)
    {
        if (!is_numeric($error_correction)) {
            $level_constant = 'QrCode\QrCode::LEVEL_'.strtoupper($error_correction);
