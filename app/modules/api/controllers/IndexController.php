...
class IndexController extends ControllerBase
{
    ...
    public function getResultDetail($type, $zAvoid, $zAnxious, $isDesc){
        ...
        if($isDesc){
            ...
            switch ($type) {
                case '安全型':
                    $desc = '安全型的人本能地信任恋人，相信恋人爱他们，关怀他们，认为伴侣会给自己足够的支持，对亲密关系的展望更乐观。在共有情形下舒适自在，只要伴侣需要，他们就会提供关心和支持。';
                    break;
                case '倾注型':
                    $desc = '倾注型的人对情绪的反应敏感。容易察觉到对方情绪的波动，并热衷于猜测对方言行背后的态度。倾向于以共有规范慷慨地对待未来的伴侣，但一旦别人同样待他们就会变得焦虑。';
                    break;
                case '轻视型':
                    $desc = '轻视型的人对待感情的态度并不直截了当。他们只有当忙于应付其它问题的时候，真实的情感才能流露出来。并不在意伴侣的信任，对亲密关系的渴求也不强烈。';
                    break;
                case '害怕型':
                    $desc = '害怕型的人会选择性地表现倾注和轻视型的特点。表现特征会在倾注型和轻视型之间摇摆，渴求亲密关系，对于伴侣既不是很放心，但又不会有强烈的反应，很多情况都会憋在自己心里不表达出来。';
                    break;
                default:
                    break;
            }
