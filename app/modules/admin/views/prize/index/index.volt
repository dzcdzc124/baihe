                                ...
                                <table class="table table-hover table-form-control no-margin">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="#" data-remote="{{ url('/admin/prize/index/update/', ['id': item.id]) }}" data-trigger="dialog"><i class="glyphicon glyphicon-pencil"></i></a>
                                            </td>
                                        </tr>
                                        {% endfor %}
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            <td colspan="8">
                                                <a href="#" data-remote="{{ url('/admin/prize/index/create/') }}" data-trigger="dialog" class="btn btn-sm btn-default pull-left"><i class="glyphicon glyphicon-plus"></i> 新增奖品</a>
